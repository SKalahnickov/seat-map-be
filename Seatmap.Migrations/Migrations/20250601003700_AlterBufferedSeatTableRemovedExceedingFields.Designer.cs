...
namespace Seatmap.Migrations.Migrations
{
    ...
    [Migration("20250601003700_AlterBufferedSeatTableRemovedExceedingFields")]
    partial class AlterBufferedSeatTableRemovedExceedingFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Seatmap.DAL.Models.BufferedSeat", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("buffered_seat", (string)null);
                });
            ...
            modelBuilder.Entity("Seatmap.DAL.Models.StaticImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("static_image", (string)null);
                });
            ...
            modelBuilder.Entity("Seatmap.DAL.Models.VehicleVersion", b =>
                {
                    ...
                    b.Property<bool>("UnrotateNumbers")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
            ...
            modelBuilder.Entity("Seatmap.DAL.Models.Layer", b =>
                {
                    ...
                    b.Navigation("StaticImages");
                });

            modelBuilder.Entity("Seatmap.DAL.Models.Vehicle", b =>
                {
                    b.Navigation("BufferedSeats");
